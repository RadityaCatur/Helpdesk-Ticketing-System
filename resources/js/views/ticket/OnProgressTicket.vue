    ...
    <div class="row">
      ...
      <div class="col-md-12">
        <b-table
          ...
          :busy="loading"
          responsive
          empty-text="Tidak ada tiket dengan status onProgress"
        >
          <template v-slot:cell(no)="data">
            {{ data.index + 1 }}
          </template>
          <template v-slot:cell(status)="data">
            <div v-if="data.item.status == 'onProgress'">On Progress</div>
          </template>
          ...
          <template v-slot:cell(actions)="row">
            ...
            <!-- <button class="btn-fill btn-warning btn-sm" @click="row.toggleDetails">
